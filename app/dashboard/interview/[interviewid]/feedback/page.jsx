    ...
    <div className="p-10">
      {feedbackList.length === 0 ? (
        ...
        <>
          ...
          <h2 className="text-lg my-3 text-blue-500">
            Your overall interview rating: <strong>7/10</strong>
          </h2>

          <h2 className="text-sm text-gray-500">
            Find below interview question with Your answer and feedback for
            improvement
          </h2>
          ...
          {feedbackList &&
            feedbackList.map((item, index) => (
              <Collapsible key={index} className="mt-7">
                <CollapsibleTrigger className="p-2 rounded-lg my-2 bg-slate-100 text-left flex justify-between gap-7 w-full">
                  Q{index + 1}. {item.question}{" "}
                  <ChevronsUpDown className="h-5 w-5" />
                </CollapsibleTrigger>
                <CollapsibleContent>
                  <div className="flex flex-col gap-2">
                    <h2 className="p-2 text-red-500 rounded-lg border">
